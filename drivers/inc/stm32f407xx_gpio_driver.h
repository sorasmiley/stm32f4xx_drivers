...
typedef struct
{
	...
	GPIO_RegDef_t *pGPIOx; //*pGPIOBaseAddr
...
void GPIO_WriteToOutputPin(GPIO_RegDef_t *pGPIOx, uint8_t, uint8_t Value);
...
/****************************************************
 * @GPIO_PIN_MODES
 * GPIO pin possible modes (8.4.1 input register)
 ****************************************************/
...
/*********************************************************
 * @GPIO_OUTPUT_TYPES
 * GPIO pin possible output types (8.4.2 output register)
 *********************************************************/
...
/*********************************************************
 * @GPIO_PIN_SPEED
 * GPIO pin possible output types (8.4.3 speed register)
 *********************************************************/
